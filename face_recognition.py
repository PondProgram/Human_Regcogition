...
class FaceRecognition:
    def __init__(self, data_directory):
        ...
        weights_face = os.path.join(self.directory, "C:/Users/HP/Desktop/Model_Human_Recognition/data/models/face_detection_yunet_2023mar.onnx")
        ...
        weights_recog = os.path.join(self.directory, "C:/Users/HP/Desktop/Model_Human_Recognition/data/models/face_recognizer_fast.onnx")
    ...
    def load_registered_faces(self):
        ...
        files = []
        for a_type in types:
            files.extend(glob.glob(os.path.join(self.directory, 'C:/Users/HP/Desktop/Model_Human_Recognition/data/images', a_type)))
